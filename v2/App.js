...
const LoginScreen = ({ navigation }) => {
  ...
  const buttonStyles = areFieldsFilled() ? styles.button : [styles.button, styles.buttonDisabled];
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="Login">
        ...
        <Stack.Screen name="calculoVolumeP" component={CalculoVolumeP}/>
        <Stack.Screen name="calculoVolumeC" component={CalculoVolumeC}/>
      </Stack.Navigator>
    </NavigationContainer>
  );
};
...
const styles = StyleSheet.create({
  ...
  newButton: {
    width: '80%',
    height: 40,
    backgroundColor: 'blue', // Cor do novo botão
    justifyContent: 'center',
    alignItems: 'center',
    borderRadius: 5,
    marginBottom: 10,
