import React, { useState } from 'react'; // Importe useState para usar os estados
...
const MainScreen = () => {
  ...
  const [num1, setNum1] = useState(''); // Estado para o primeiro input
  const [num2, setNum2] = useState(''); // Estado para o segundo input
