...
function criarSubPartes() {
  ...
  btn.addEventListener("click", function () {
    ...
    console.log(pesoCavaco);
    console.log(precoCavaco);
    console.log(totalMaoDeObra);
    console.log(totalMaquina);  
    let valorDeCavaco = pesoCavaco * precoCavaco;

    let custoProducao = (peso * precoMaterial) + (pesoCavaco * precoCavaco) + totalMaoDeObra + totalMaquina;
    let custoProducaoFormatado = custoProducao.toFixed(2)
    
    console.log("Logo a Baixo custo de produção");
    console.log(custoProducaoFormatado);
    document.querySelector(
