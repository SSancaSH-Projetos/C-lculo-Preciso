...
fetch('http://localhost:8080/material')
  ...
  // btn.addEventListener("click", function (somaDosVolumes) {
  //    // 1 kg = 1.000.000 mm³
  //    let kg = somaDosVolumes / 1000000;
  //    console.log(somaDosVolumes)
  //    console.log(kg)
  // });
...
btn.addEventListener("click", function () {
   // 1 kg = 1.000.000 mm³
   let kg = somaDosVolumes / 1000000;
   let kgCavaco = volumeCavaco / 1000000;
   console.log(kg)
   console.log(kgCavaco)
});
