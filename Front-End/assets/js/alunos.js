...
function submeterFormulario(event) {
    ...
    fetch("https://be-calculo-preciso.azurewebsites.net/usuarios", {
        method: "POST",
        headers: {
...
function fetchUsuarios() {
    fetch('https://be-calculo-preciso.azurewebsites.net/usuarios/alunos')
...
function showEditForm(email) {
    fetch(`https://be-calculo-preciso.azurewebsites.net/usuarios/${email}`)
        .then(response => response.json())
        .then(usuario => {
