...
AFRAME.registerComponent("model-viewer", {
  ...
  initUploadInput: function () {
    var uploadContainerEl = (this.uploadContainerEl =
      document.createElement("div"));
    var inputEl = (this.inputEl = document.createElement("input"));
    var submitButtonEl = (this.submitButtonEl =
    ...
    var inputDefaultValue = (this.inputDefaultValue =
      "Copy URL to glTF or glb model");
  ...
  initEntities: function () {
    ...
    shadowEl.setAttribute(
      "geometry",
      "primitive: plane; width: 1.0; height: 1.0"
    );
    shadowEl.setAttribute(
      "material",
      "src: #shadow; transparent: true; opacity: 0.40"
    );
